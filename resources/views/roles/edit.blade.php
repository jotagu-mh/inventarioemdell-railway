...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2 class="mb-0">✏️ Modifique la información del rol</h2>
        </div>
    </div>
            ...
            <form action="{{ route('roles.update', $rol) }}" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                      ...
                                      name="descripcion" 
                                      rows="3"
                                      placeholder="Descripción opcional del rol y sus responsabilidades">{{ old('descripcion', $rol->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                @if($rol->usuarios->count() > 0)
                    <div class="alert alert-info">
                        ...
                        <strong>Información:</strong> Este rol está asignado a 
                        <strong>{{ $rol->usuarios->count() }}</strong> usuario(s).
                    </div>
                @endif
