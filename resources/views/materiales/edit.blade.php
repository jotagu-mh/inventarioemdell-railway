...
<div class="container">
    <div class="row mb-3">
        <div class="col-md-6">
            <h2><i class="fa-solid fa-pen-to-square"></i> Modificar información del material</h2>
        </div>
            ...
            <form action="{{ route('materiales.update', $material) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('codigo') is-invalid @enderror" 
                               id="codigo" name="codigo" value="{{ old('codigo', $material->codigo) }}" required>
                        @error('codigo')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                              id="descripcion" name="descripcion" rows="3">{{ old('descripcion', $material->descripcion) }}</textarea>
                    @error('descripcion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('unidad_medida') is-invalid @enderror" 
                            ...
                            <option value="piezas" {{ old('unidad_medida', $material->unidad_medida) == 'piezas' ? 'selected' : '' }}>Piezas</option>
                            <option value="kg" {{ old('unidad_medida', $material->unidad_medida) == 'kg' ? 'selected' : '' }}>Kilogramos</option>
                            <option value="litros" {{ old('unidad_medida', $material->unidad_medida) == 'litros' ? 'selected' : '' }}>Litros</option>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('cantidad_actual') is-invalid @enderror" 
                               id="cantidad_actual" name="cantidad_actual" value="{{ old('cantidad_actual', $material->cantidad_actual) }}" min="0" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('cantidad_minima') is-invalid @enderror" 
                               id="cantidad_minima" name="cantidad_minima" value="{{ old('cantidad_minima', $material->cantidad_minima) }}" min="0" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('precio_unitario') is-invalid @enderror" 
                               id="precio_unitario" name="precio_unitario" value="{{ old('precio_unitario', $material->precio_unitario) }}" min="0" required>
